...
require 'env/commands/describe_plugin'
require 'env/commands/list'
require 'env/commands/list_envs'
require 'env/commands/list_plugins'
require 'env/commands/add_plugin'
require 'env/commands/remove_plugin'
