# Contributing to Flight Environment

:+1::tada: Thanks for taking the time to contribute! :tada::+1:

You want to contribute to Flight Environment? Welcome! Please read this
...
You can help Flight Environment by helping others who use it and need support.
...
If you find a bug - behaviour of Flight Environment code or documentation
...
We want to improve the quality of Flight Environment and good bug reports are
...
Flight Environment is Open Source and comes without warranty.
...
Flight Environment in order to fix bugs or to implement new features.
...
2. **Not all proposed contributions can be accepted**. Some features
   ...
   the overall direction of Flight Environment and really improve it. The more
...
applied to Flight Environment itself.
...
8. Wait for our code review and approval, possibly enhancing your
   change on request.
    - Note that the Flight Environment developers also have their regular
